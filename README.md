...
### 購入先
[BASE](https://xmakers.base.shop/items/75464226)
[スイッチサイエンス](https://www.switch-science.com/catalog/6394/)
...
### 設定方法
1. firmware/data_kahokuフォルダからお住いの地区のゴミの日データ（data_garbage_xx.csv）をコピーして、firmware/arduino-ide/5374gadget/dataフォルダに貼り付ける
